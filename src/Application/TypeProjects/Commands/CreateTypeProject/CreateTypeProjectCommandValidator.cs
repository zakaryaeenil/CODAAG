...
public class CreateTypeProjectCommandValidator : AbstractValidator<CreateTypeProjectCommand>
{
    private readonly IApplicationDbContext _context;

    public CreateTypeProjectCommandValidator(IApplicationDbContext context)
    {
        _context = context;
